...
insert into aluguel(`idCliente`, `idFuncionario`, `dataHoraRetirada`) values(7, 1, '2026-05-01');
...
select COUNT(c.`nomeCliente`) as 'Qtd', a.`formaPagamento` as 'Forma Pgt.' from aluguel a
JOIN cliente c on a.`idCliente` = c.`idCliente`
